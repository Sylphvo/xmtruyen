...
export const DATABASE_TABLE_DICTIONARY: Record<string, TableDescription> = {
  ...
  Publications: {
    ...
    columns: {
      ...
      CreatedBy: { label: "Người tạo", description: "Tên hoặc email của người tạo bản ghi", example: "admin@xomtruyen.com" },
      UpdatedBy: { label: "Người sửa", description: "Tên hoặc email của người cập nhật lần cuối", example: "editor@xomtruyen.com" },

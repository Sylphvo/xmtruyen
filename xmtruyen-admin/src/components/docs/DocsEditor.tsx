...
import { ArrowLeft, Save, Eye, Check, Edit2 } from 'lucide-react';
    ...
    <div className="container-fluid p-4" data-color-mode="light">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div className="d-flex align-items-center gap-3">
          ...
          <h2 className="m-0" style={{ fontSize: '20px', fontWeight: 600 }}>
            {!docId ? 'Tạo tài liệu mới' : isEditing ? 'Chỉnh sửa tài liệu' : title}
          </h2>
        </div>
        <div className="d-flex gap-2">
          {!isEditing ? (
            ...
            <>
              {docId && (
                <button 
                  className="btn btn-light d-flex align-items-center gap-2 me-2"
      ...
      <div className="card shadow-sm border-0 mb-4">
        <div className="card-body">
          {!isEditing ? (
            <div className="px-2 py-3" data-color-mode="light">
              <div className="mb-4 pb-3 border-bottom">
                <span className="jira-status-toggle no-arrow me-2" style={{ display: 'inline-block', cursor: 'default' }}>{type}</span>

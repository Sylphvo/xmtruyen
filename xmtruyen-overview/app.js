...
const APP_DATA = {
  ...
  nodes: {
    ...
    "xmtruyen-hub": {
      ...
      subtitle: "xmtruyen workspace",
      type: "root",
      color: "cyan",
      category: "Ecosystem Core",
      path: "c:\\Users\\Cilse\\source\\xmtruyen\\Xmtruyen_Workspace",
      ...
      files: [
        ...
        "xmtruyen-admin (Admin Dashboard)",
        "xmtruyen-app (Mobile App)",
        "xmtruyen.API (ASP.NET Core 9 Web API)",
  ...
  "ecosystem": {
    ...
    "adminPortal": "xmtruyen-admin (React 19 + AG-Grid + ApexCharts)",
    "mobileApp": "xmtruyen-app (Ionic 8 + Capacitor 8 + React)",
    "backendApi": "xmtruyen.API (ASP.NET Core 9 + EF Core)",
    ...
    "xom-truyen": {
      ...
      color: "cyan",
      category: "Web Client",
      path: "c:\\Users\\Cilse\\source\\xmtruyen\\Xmtruyen_Workspace\\xom-truyen",
...
export default function App() {
  return (
    ...
    "xmtruyen-app": {
      ...
      path: "c:\\Users\\Cilse\\source\\xmtruyen\\Xmtruyen_Workspace\\xmtruyen-app",
...
export default config;`
    ...
    "xmtruyen.API": {
      ...
      path: "c:\\Users\\Cilse\\source\\xmtruyen\\Xmtruyen_Workspace\\xmtruyen.API",
...
app.Run();`
    ...
    "xmtruyen-admin": {
      id: "xmtruyen-admin",
      title: "XMTRUYEN-ADMIN",
      subtitle: "management portal",
      type: "admin",
      color: "amber",
      category: "Admin Portal",
      path: "c:\\Users\\Cilse\\source\\xmtruyen\\Xmtruyen_Workspace\\xmtruyen-admin",
...
export const Dashboard: React.FC = () => {
  ...
  return (
    ...
    "postgres-db": {
      ...
      path: "Host=127.0.0.1;Port=5432;Database=xmtruyen",
      ...
      runCommand: "psql -U postgres -d xmtruyen",
      ports: "5432",
...
export default function LoginPage() {
  ...
  return <form onSubmit={handleLogin}><button type="submit">Đăng nhập</button></form>;
    ...
    // ----------------------------------------------------
    // Tier 2: Sub-systems attached underneath xmtruyen-app
    // ----------------------------------------------------
    "app-sub-read": {
      id: "app-sub-read",
      ...
      path: "xmtruyen-app\\src\\pages\\Home.tsx",
...
export default function ReadBook() {
  return (
    ...
    "app-sub-fav-notif": {
      ...
      color: "green",
      category: "Phân hệ Mobile",
      path: "xmtruyen-app\\src\\pages\\Favorites.tsx",
  ...
  return <div>Trung tâm thông báo chương mới</div>;
    ...
    "app-sub-order": {
      ...
      color: "green",
      category: "Phân hệ Mobile",
      path: "xmtruyen-app\\src\\pages\\OrderHistory.tsx",
  ...
  return <div>Lịch sử giao dịch mua gói & chương VIP</div>;
    ...
    "app-sub-auth": {
      ...
      color: "green",
      category: "Phân hệ Mobile",
      path: "xmtruyen-app\\src\\pages\\SignIn.tsx",
  ...
  return <div>Đăng nhập tài khoản di động</div>;
    ...
    // ----------------------------------------------------
    // Tier 2: Sub-systems attached underneath xmtruyen.API
    // ----------------------------------------------------
    "api-sub-pub": {
      id: "api-sub-pub",
      ...
      path: "xmtruyen.API\\Controllers\\AdminPublicationController.cs",
...
public class UploadController : ControllerBase
{
    ...
    "api-sub-reading": {
      ...
      color: "purple",
      category: "Phân hệ API",
      path: "xmtruyen.API\\Controllers\\ReadingController.cs",
...
public async Task<ActionResult<ApiResponse<ChapterContentResponse>>> GetChapterContent(Guid chapterId)
{
    ...
    "api-sub-auth": {
      ...
      color: "purple",
      category: "Phân hệ API",
      path: "xmtruyen.API\\Controllers\\AuthController.cs",
...
public async Task<ActionResult<ApiResponse<AuthResponse>>> Login([FromBody] LoginRequest request)
{
    ...
    "api-sub-tax": {
      ...
      color: "purple",
      category: "Phân hệ API",
      path: "xmtruyen.API\\Controllers\\AdminCategoryController.cs",
...
public async Task<IActionResult> GetCategories()
{
    ...
    "api-sub-db-manager": {
      ...
      color: "purple",
      category: "Phân hệ API",
      path: "xmtruyen.API\\Controllers\\ManagerDBController.cs",
...
public async Task<IActionResult> GetTables()
{
    ...
    "api-sub-worker": {
      ...
      color: "purple",
      category: "Phân hệ API",
      path: "xmtruyen.API\\Services\\Background",
        ...
        raw: `public class BookProcessingWorker : BackgroundService
{
    ...
    // ----------------------------------------------------
    // Tier 2: Sub-systems attached underneath xmtruyen-admin
    // ----------------------------------------------------
    "admin-sub-books": {
      id: "admin-sub-books",
      ...
      path: "xmtruyen-admin\\src\\pages\\Books.tsx",
  ...
  return <div className="admin-books">Quản lý sách và tệp tin</div>;
    ...
    "admin-sub-tax": {
      ...
      color: "amber",
      category: "Phân hệ Admin",
      path: "xmtruyen-admin\\src\\pages\\Categories.tsx",
    ...
    "admin-sub-users": {
      ...
      color: "amber",
      category: "Phân hệ Admin",
      path: "xmtruyen-admin\\src\\pages\\Users.tsx",
    ...
    "admin-sub-dashboard": {
      ...
      color: "amber",
      category: "Phân hệ Admin",
      path: "xmtruyen-admin\\src\\pages\\Dashboard.tsx",
    ...
    "admin-sub-db-viewer": {
      ...
      color: "amber",
      category: "Phân hệ Admin",
      path: "xmtruyen-admin\\src\\pages\\Database.tsx",
    ...
    "db-sub-books": {
      ...
      path: "xmtruyen.API\\Data\\ApplicationDbContext.cs",
...
public async Task<IActionResult> GetTables()
{
    ...
    "multi-tier": {
      ...
      pipelineChips: ["Xmtruyen Hub", "xom-truyen (Web)", "xmtruyen-app (Mobile)", "xmtruyen.API (Backend)", "xmtruyen-admin (Admin)", "PostgreSQL DB"],
  ...
  changelog: [
    {
      ...
      doc: {
        ...
        endpoints: [
          ...
          { method: "GET", path: "xmtruyen-overview/index.html", desc: "Trang chủ Dashboard trực quan hóa kiến trúc và tài liệu." }
        ],
        files: [
          { path: "xmtruyen-overview/index.html", role: "Giao diện chính chứa Bảng Luồng, Nhật ký Changelog, Sơ đồ SVG và các Dialog mã nguồn." },
          { path: "xmtruyen-overview/style.css", role: "Hệ thống CSS Cyberpunk Dark Theme, Custom Neon Glow, Flex/Grid Layout và Syntax Highlighting." },
          { path: "xmtruyen-overview/app.js", role: "Toàn bộ dữ liệu kiến trúc hệ thống, kho mã nguồn thực tế và logic tương tác canvas / modal." }
        ],
        code: {
          filename: "xmtruyen-overview/app.js",
          lang: "javascript",
  ...
  return (
    ...
    },
    {
      ...
      doc: {
        ...
        files: [
          { path: "xmtruyen-app/capacitor.config.ts", role: "Cấu hình Native App ID, Plugins SplashScreen, StatusBar, Haptics." },
          { path: "xmtruyen-app/src/pages/ReadBook.tsx", role: "Giao diện đọc truyện di động tối ưu cảm ứng và chế độ ban đêm." }
        ],
        code: {
          filename: "xmtruyen-app/src/pages/ReadBook.tsx",
          lang: "typescript",
  ...
  return (
    <IonPage>
      <IonContent fullscreen className="dark-reader-content">
        ...
        testing: [
          { title: "Bước 1: Chạy môi trường Mobile", detail: "Chạy 'npm run dev' trong thư mục xmtruyen-app." },
    ...
    },
    {
      ...
      apps: ["xmtruyen.API", "xmtruyen-admin", "xom-truyen"],
      ...
      doc: {
        ...
        files: [
          { path: "xmtruyen.API/Controllers/ReadingController.cs", role: "Controller xử lý lấy dữ liệu chương và lưu lịch sử đọc." },
          { path: "xmtruyen.API/Models/ComicChapter.cs", role: "Entity định nghĩa bảng ComicChapters trong PostgreSQL." },
          { path: "xmtruyen.API/Models/ComicPage.cs", role: "Entity định nghĩa bảng ComicPages chứa URL ảnh từng trang." }
        ],
        code: {
          filename: "xmtruyen.API/Controllers/ReadingController.cs",
          lang: "csharp",
...
public async Task<IActionResult> GetComicChapter(Guid chapterId)
{
    ...
    },
    {
      ...
      apps: ["xmtruyen.API", "xmtruyen-admin"],
      ...
      doc: {
        ...
        files: [
          { path: "xmtruyen.API/Controllers/UploadController.cs", role: "Tiếp nhận file chunk 500MB và đẩy vào Queue." },
          { path: "xmtruyen.API/Services/Background/BackgroundTaskQueue.cs", role: "Channel Queue bounded 100 items." },
          { path: "xmtruyen.API/Services/Background/BookProcessingWorker.cs", role: "Background Service tự động giải nén và ghi CSDL." }
        ],
        code: {
          filename: "xmtruyen.API/Controllers/UploadController.cs",
          lang: "csharp",
...
public async Task<IActionResult> UploadBookArchive([FromForm] IFormFile file)
{
    ...
    },
    {
      ...
      doc: {
        ...
        files: [
          { path: "xmtruyen-admin/src/pages/Categories.tsx", role: "Trang quản lý thể loại với bảng AG-Grid Inline Creation." },
          { path: "xmtruyen-admin/src/pages/Books.tsx", role: "Trang quản lý danh sách truyện tranh." }
        ],
        code: {
          filename: "xmtruyen-admin/src/pages/Categories.tsx",
          lang: "typescript",
  ...
  if (!updatedRow.id) {
    ...
    },
    {
      ...
      apps: ["xmtruyen-admin", "xmtruyen.API"],
      ...
      doc: {
        ...
        files: [
          { path: "xmtruyen-admin/src/pages/Users.tsx", role: "Giao diện quản lý danh sách thành viên." },
          { path: "xmtruyen.API/Controllers/AdminUserController.cs", role: "API quản trị tài khoản và phân quyền." }
        ],
        code: {
          filename: "xmtruyen.API/Controllers/AdminUserController.cs",
          lang: "csharp",
...
public class AdminUserController : ControllerBase
{
    ...
    public async Task<IActionResult> GetUsersList([FromQuery] int page = 1, [FromQuery] int pageSize = 20)
    {
        ...
        testing: [
          { title: "Bước 1: Đăng nhập quyền Admin", detail: "Đăng nhập vào Admin Portal với tài khoản admin@xmtruyen.com." },
    ...
    },
    {
      ...
      doc: {
        ...
        files: [
          { path: "xmtruyen.API/Data/ApplicationDbContext.cs", role: "DbContext quản lý 18 DbSets." },
          { path: "xmtruyen.API/Program.cs", role: "Khởi tạo Dependency Injection, Middleware, JWT Auth." }
        ],
        code: {
          filename: "xmtruyen.API/Program.cs",
          lang: "csharp",
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options => {
        ...
        testing: [
          { title: "Bước 1: Chạy API", detail: "Mở terminal chạy 'dotnet run' trong thư mục xmtruyen.API." },
...
class ArchitectureVisualizer {
  constructor() {
    ...
    this.currentTheme = localStorage.getItem("xmtruyen_overview_theme") || "slate";
  ...
  applyTheme(theme) {
    ...
    localStorage.setItem("xmtruyen_overview_theme", theme);
  ...
  renderMultiTierTree(centerX, height) {
    // 1. Root Node (Tier 0)
    const rootY = 90;
    const rootData = APP_DATA.nodes["xmtruyen-hub"];

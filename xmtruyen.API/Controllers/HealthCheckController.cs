...
public class HealthCheckController : ControllerBase
{
    ...
    public async Task<IActionResult> GetHealthStatus()
    {
        ...
        {
            result.Services.Add(new ServiceStatus("PostgreSQL", "DOWN", 0, Xmtruyen.API.Helpers.ExceptionHelper.GetFriendlyMessage(ex)));
        }
        ...
        {
             result.Services.Add(new ServiceStatus("FileStorage", "UNKNOWN", 0, Xmtruyen.API.Helpers.ExceptionHelper.GetFriendlyMessage(ex)));
        }

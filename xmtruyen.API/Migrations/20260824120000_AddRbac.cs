...
public partial class AddRbac : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.Sql("INSERT INTO \"UserRoles\" (\"UserId\", \"RoleId\", \"AssignedAt\") SELECT \"Id\", 1, NOW() FROM \"Users\" WHERE \"Email\" = 'admin@xmtruyen.com' ON CONFLICT (\"UserId\", \"RoleId\") DO NOTHING;");

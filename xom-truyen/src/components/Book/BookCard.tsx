...
export default function BookCard({ book, size = "normal" }: { book: Book; size?: "normal" | "large" }) {
    ...
    return (
        <div style={{
            ...
            onMouseLeave={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 4px 10px rgb(245, 241, 235), 0 1px 3px rgb(245, 241, 235)";
            }}
        >
            ...
            <div style={{ marginTop: 12 }}>
                ...
                <p style={{ fontSize: 11, color: "#666", margin: "4px 0" }}>{book.author}</p>
            </div>
        </div>
    );
}
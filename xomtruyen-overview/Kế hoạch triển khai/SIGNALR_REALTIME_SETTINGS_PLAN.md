...
```text
xomtruyen.API/Hubs/NotificationHub.cs
/hubs/notification
```
...
```text
xomtruyen-admin/src/config/realtimeConfig.ts
```
...
```text
xomtruyen-admin/src/pages/RealtimeSettings.tsx
```
...
```text
xomtruyen.realtime.settings.v1
```
...
```text
xomtruyen-admin/src/services/realtimeService.ts
```
...
```text
xomtruyen-admin/src/hooks/useRealtime.ts
```
...
```text
xomtruyen-admin/src/services/pollingService.ts
```
...
```text
xomtruyen.API/Hubs/MonitoringHub.cs
```
...
```text
xomtruyen.API/Services/Realtime/IRealtimePublisher.cs
xomtruyen.API/Services/Realtime/SignalRRealtimePublisher.cs
```

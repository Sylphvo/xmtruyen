...
```text
xomtruyen-admin/src/state/pendingChangesStore.ts
xomtruyen-admin/src/hooks/usePendingChanges.ts
```
...
```text
xomtruyen-admin/src/components/ApplyDataButton.tsx
```
...
```text
xomtruyen-admin/src/components/ManagementToolbar.tsx
```
...
```text
xomtruyen.API/Controllers/Admin/AdminApplyController.cs
xomtruyen.API/Contracts/ApplyData/
xomtruyen.API/Services/ApplyData/
```

...
- `xomtruyen.API/business_logic.md`: quyền đọc, quảng cáo, VIP, xu và chapter.
- `xomtruyen.API/handle_bulk_upload_chapters.md`: upload chapter hàng loạt.
- `xomtruyen.API/handle_book.md`: xử lý PDF/EPUB và storage.
- `xomtruyen-admin/src/pages/BookVideoDashboard.tsx`: quản lý video truyện chữ.
- `xomtruyen-admin/src/pages/ComicVideoDashboard.tsx`: quản lý video truyện tranh.
- `xomtruyen.API/Services/BookVideo`: tạo nội dung/video từ sách chữ.
- `xomtruyen.API/Services/VideoConvert`: worker chuyển đổi video.

...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XomTruyen.API.Models.ComicPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.CourseEnrollment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.CoursePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.CourseSection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.ErrorLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.FaqItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.ImportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.Lesson", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.LessonProgress", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.LessonVideo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.NormalizedImportRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.Permission", b =>
                {
            ...
            modelBuilder.Entity("XomTruyen.API.Models.PublicationCategory", b =>
                {
                    b.Property<Guid>("PublicationId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.PublicationTopic", b =>
                {
                    b.Property<Guid>("PublicationId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.ReaderPreference", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.RoleAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.RolePermission", b =>
                {
                    b.Property<int>("RoleId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.StaticPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("XomTruyen.API.Models.ComicPage", b =>
                {
                    b.HasOne("XomTruyen.API.Models.ComicChapter", "ComicChapter")
                        .WithMany("Pages")
            ...
            modelBuilder.Entity("XomTruyen.API.Models.Course", b =>
                {
                    b.HasOne("XomTruyen.API.Models.User", "Instructor")
                        .WithMany()
            ...
            modelBuilder.Entity("XomTruyen.API.Models.CourseEnrollment", b =>
                {
                    b.HasOne("XomTruyen.API.Models.Course", "Course")
            ...
            modelBuilder.Entity("XomTruyen.API.Models.ImportJob", b =>
                {
                    b.HasOne("XomTruyen.API.Models.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("XomTruyen.API.Models.Lesson", b =>
                {
                    b.HasOne("XomTruyen.API.Models.CourseSection", "Section")
                        .WithMany("Lessons")
            ...
            modelBuilder.Entity("XomTruyen.API.Models.LessonProgress", b =>
                {
                    b.HasOne("XomTruyen.API.Models.Lesson", "Lesson")
                        .WithMany("Progresses")
            ...
            modelBuilder.Entity("XomTruyen.API.Models.LessonVideo", b =>
                {
                    b.HasOne("XomTruyen.API.Models.Lesson", "Lesson")
                        .WithOne("Video")
                        .HasForeignKey("XomTruyen.API.Models.LessonVideo", "LessonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("XomTruyen.API.Models.NormalizedImportRow", b =>
                {
                    b.HasOne("XomTruyen.API.Models.ImportJob", "ImportJob")
                        .WithMany("Rows")
            ...
            modelBuilder.Entity("XomTruyen.API.Models.RolePermission", b =>
                {
                    b.HasOne("XomTruyen.API.Models.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("XomTruyen.API.Models.Role", "Role")
                        .WithMany("RolePermissions")

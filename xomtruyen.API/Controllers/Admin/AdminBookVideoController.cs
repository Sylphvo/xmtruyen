...
namespace XomTruyen.API.Controllers.Admin
{
    ...
    public class AdminBookVideoController : ControllerBase
    {
        ...
        private readonly XomTruyen.API.Services.BookVideo.IBookVideoJobQueue _queue;

        public AdminBookVideoController(ApplicationDbContext context, XomTruyen.API.Services.BookVideo.IBookVideoJobQueue queue)
        {
            _context = context;
            _queue = queue;
        }

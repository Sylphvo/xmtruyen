...
- **Frontend Admin**: `xomtruyen-admin` (ReactJS).
- **Backend API**: `xomtruyen.API` (.NET Core Web API).
- **Database**: PostgreSQL (truy xuất qua Entity Framework Core/Repositories).

---

## 3. Hướng dẫn Triển khai Backend (`xomtruyen.API`)
...
## 4. Hướng dẫn Triển khai Frontend (`xomtruyen-admin`)
